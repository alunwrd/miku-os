...
MikuOS は NVIDIA Turing シリーズ GPU (GTX 1650 / 1660) 向けのネイティブドライバーを含みます。
...
> 現在のドライバーは host-side probe + Falcon エンジン管理 + DMA ループバックをカバーします。
...
| 7 | - | SEC2 ACR ブート (WPR セットアップ) |
| 8 | - | NVDEC スクラバーパス |
| 9 | - | GSP-RM ステージング + GSP RPC |
