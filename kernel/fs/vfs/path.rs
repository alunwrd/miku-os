use crate::fs::vfs::hash::name_hash;
...
impl PathWalker {
    pub fn resolve(
        nodes: &[crate::fs::vfs::vnode::VNode; MAX_VNODES],
        cwd: usize,
        path: &str,
    ) -> VfsResult<usize> {
        let path = path.trim();
    ...
    #[inline]
    pub fn effective_node(_nodes: &[crate::fs::vfs::vnode::VNode; MAX_VNODES], id: usize) -> usize {
        id
    }
