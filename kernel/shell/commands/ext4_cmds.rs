...
use crate::fs::ext::FsError;
use crate::{cprintln, print_error, print_success, println};
use crate::shell::commands::ext2_cmds::{with_ext2_pub, is_ext2_ready};
use crate::shell::commands::ext_cmds_common as common;
...
pub fn cmd_ext4_mount(args: &str) {
    crate::shell::commands::ext2_cmds::cmd_ext2_mount(args);
...
pub fn cmd_ext4_upgrade() {
    let result = with_ext2_pub(|fs| -> Result<crate::fs::ext::ext4::upgrade::Ext4UpgradeReport, FsError> {
        fs.ext4_upgrade()
    });
    match result {
