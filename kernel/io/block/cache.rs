...
// through 'crate::io::block', so there is no second path that could observe  stale data
...
pub struct BufferCache {
    ...
    last_chunk: [u64; crate::fs::vfs::types::MAX_BLOCK_DEVICES],
    /// Consecutive sequential chunks per device (readahead ramp-up)
    streak:     [u32; crate::fs::vfs::types::MAX_BLOCK_DEVICES],
    pub hits:   u64,
    pub misses: u64,
    pub readaheads: u64,
...
impl BufferCache {
    pub fn new() -> Self {
        ...
        Self {
            ...
            tick:    0,
            last_chunk: [u64::MAX; crate::fs::vfs::types::MAX_BLOCK_DEVICES],
            streak:     [0u32; crate::fs::vfs::types::MAX_BLOCK_DEVICES],
            hits:    0,
            misses:  0,
            readaheads: 0,
            write_merges: 0,
