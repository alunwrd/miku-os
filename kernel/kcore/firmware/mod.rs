...
pub fn disable_amd_chipset_smi() {
    ...
    crate::mm::vmm::map_mmio_uc(acpimmio_phys, 0x1000);
...
pub fn disable_hpet_smi() {
    ...
    crate::mm::vmm::map_mmio_uc(hpet_phys, 0x1000);
...
pub fn configure_lapic_per_madt() {
    ...
    let bsp_id = crate::arch::x86_64::apic::lapic_id() as u8;
    let mut off = 36u64 + 8;
    while off + 2 < total {
    ...
    unsafe {
        crate::arch::x86_64::apic::lapic_write(crate::arch::x86_64::apic::LAPIC_LVT_LINT0, lint0_val);
        crate::arch::x86_64::apic::lapic_write(crate::arch::x86_64::apic::LAPIC_LVT_LINT1, lint1_val);
    }
    crate::cprintln!(180, 180, 180,
